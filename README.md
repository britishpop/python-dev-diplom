...
Базовая часть:
1. [Создание и настройка проекта](./assignment/reference/step-1.md)
2. [Проработка моделей данных](./assignment/reference/step-2.md)
3. [Реализация импорта товаров](./assignment/reference/step-3.md)
4. [Реализация forms и views](./assignment/reference/step-4.md)
5. [Полностью готовый backend](./assignment/reference/step-5.md)

Продвинутая часть (по желанию, если базовая часть полностью готова):

6. [Реализация forms и views админки склада](./assignment/reference/step-6-adv.md)
7. [Вынос медленных методов в задачи Celery](./assignment/reference/step-7-adv.md)
...
[перейдите по ссылке](./assignment/reference/step-1.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](./assignment/reference/step-2.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](./assignment/reference/step-3.md).

### Этап 4. Реализация forms и views

Критерии достижения:

1. Реализованы формы и views для основных [страниц](./assignment/reference/screens.md) сервиса (без админки)
   - Вход
   - Регистрация
   - Список товаров
   - Карточка товара
...
Для получения подробностей по данному этапу
[перейдите по ссылке](./assignment/reference/step-4.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](./assignment/reference/step-5.md).

## Полезные материалы

1. [Информация о сервисе](./assignment/reference/service.md)
2. [Спецификация API](./assignment/reference/api.md)
3. [Описание страниц сервиса](./assignment/reference/screens.md)
...
1. Реализованы формы и views для [страниц админки](./assignment/reference/screens.md) сервиса


Для получения подробностей по данному этапу
[перейдите по ссылке](assignment/reference/step-6-adv.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](assignment/reference/step-7-adv.md).
